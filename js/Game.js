...
ZenikaRPG.Game.prototype = {
    ...
    update: function () {
        ...
        if (this.ship.isAllowedToMove) {
            ...
            if (this.game.input.activePointer.isDown) {
                ...
                //console.log(this.game.input.x, this.game.input.y, this.ship.body.x, this.ship.body.y);
            }
            else {
    ...
    createShip: function () {
        ...
        var animationfps = 8;
        this.ship.animations.add('top', [0, 2, 0, 10], animationfps, true);
        this.ship.animations.add('down', [5, 8, 5, 11], animationfps, true);
        this.ship.animations.add('left', [6, 3, 6, 9], animationfps, true);
        this.ship.animations.add('right', [1, 4, 1, 7], animationfps, true);
        this.ship.play('down');
        ...
        this.ship.body.collides(this.ballCollisionGroup, function (body1, body2) {
        }, this);

        this.ship.body.collides(this.boxCollisionGroup, function (body1, body2) {
        }, this);

        this.ship.body.collides(this.wallCollisionGroup, function (body1, body2) { /*console.log('wall')*/
        }, this);
    ...
    createBox: function (x, y, box) {
        block = this.game.add.sprite(x, y, 'pnj-sample');
        ...
        var block2 = this.game.add.sprite(x, y, 'pnj-sample');
